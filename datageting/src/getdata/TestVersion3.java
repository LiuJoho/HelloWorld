...
public static void main(String[] args) throws FileNotFoundException {
	...
	for(String s : str){
		for (int i = 0x0; i <= 0xf; i++) {
			...
			ThreadPoolUtils.execute(new TestRunnable1(one,s));
		}
	}
}
...
class TestRunnable1 extends Thread{
	String b,first;
	public TestRunnable1(String b,String first) {
		this.b=b;
		this.first=first;
	}
	@Override
				...
				for (int y = 0x0; y <= 0xf; y++) {
					...
					for (int z = 0x0; z <= 0xf; z++) {
						...
						for (int s = 0x0; s <= 0xf; s++) {
							...
							String url = "http://www.fjadd.com/addr?id=BFC48294-0E73-00EE-E043-0A82290600EE";
							String a = HttpClientUtil.doGet(url);
